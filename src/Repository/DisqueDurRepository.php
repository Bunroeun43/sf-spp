...
/**
 * @extends ServiceEntityRepository<DisqueDur>
 *
...
class DisqueDurRepository extends ServiceEntityRepository
{
    ...
    public function save(DisqueDur $entity, bool $flush = false): void
    {
    ...
    public function remove(DisqueDur $entity, bool $flush = false): void
    {
